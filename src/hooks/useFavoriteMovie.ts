...
import { useMarkAsFavoriteMovie, useUnmarkAsFavoriteMovie } from '@/api/mutations';
import { isFavoriteMoviesKey } from '@/api/queries';
import { MovieSchemaType } from '@/models/MovieSchema';
